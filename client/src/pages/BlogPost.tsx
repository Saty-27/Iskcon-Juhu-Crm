...
const BlogPostPage = () => {
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 py-8">
          <div className="container mx-auto px-4">
            <Link href="/blog" className="inline-flex items-center text-white hover:text-green-100 transition-colors mb-4">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 py-8">
        <div className="container mx-auto px-4">
          <Link href="/blog" className="inline-flex items-center text-white hover:text-green-100 transition-colors">
            <ArrowLeft className="w-5 h-5 mr-2" />
            Back to Blog
          </Link>
        </div>
      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="mb-12">
          <div className="relative">
            <img 
              ...
              onError={(e) => {
                e.currentTarget.src = 'https://via.placeholder.com/800x500/22c55e/ffffff?text=ISKCON+Blog+Image';
              }}
            />
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex justify-center">
            <Link 
              href="/blog" 
              className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-semibold px-8 py-3 rounded-full transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg"
            >
              <ArrowLeft className="w-5 h-5 mr-2" />
              View All Blog Posts
            </Link>
