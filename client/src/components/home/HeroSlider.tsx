        ...
        <div className="absolute inset-0 z-20 flex items-end justify-center pb-8 sm:pb-12 md:pb-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-black bg-opacity-40 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 backdrop-blur-sm max-w-full">
              <h2 className="text-white font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-3 sm:mb-4 md:mb-6 lg:mb-8 leading-tight drop-shadow-lg">
    ...
    <section className="relative overflow-hidden h-[70vh] sm:h-[80vh] md:h-screen bg-gray-900">
      {banners.length > 0 && banners[currentSlide] && (
        <div className="h-full w-full flex items-center justify-center">
          ...
          />
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-end justify-center pb-8 sm:pb-12 md:pb-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
