...
Run this command on your VPS to create the database tables:

```bash
npm run db:push
```

## Step 2: Create Data Import File

Create a file called `final-import.sql` with the following content:
...
Your ISKCON Juhu donation system is now live on your VPS!